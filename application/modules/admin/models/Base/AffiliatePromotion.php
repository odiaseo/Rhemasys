...
Doctrine_Manager::getInstance()->bindComponent('Admin_Model_AffiliatePromotion', 'admin');

/**
 * Admin_Model_Base_AffiliatePromotion
 * 
 ...
 */
abstract class Admin_Model_Base_AffiliatePromotion extends Rhema_Model_Abstract
{
    public function setTableDefinition()
    {
        $this->setTableName('affiliate_promotion');
    ...
    public function setUp()
    {
        ...
        $this->hasOne('Admin_Model_AffiliateProduct as AffiliateProduct', array(
             'local' => 'id',
             'foreign' => 'affiliate_promotion_id'));
