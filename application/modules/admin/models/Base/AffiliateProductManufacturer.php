...
Doctrine_Manager::getInstance()->bindComponent('Admin_Model_AffiliateProductManufacturer', 'admin');

/**
 * Admin_Model_Base_AffiliateProductManufacturer
 * 
 ...
 */
abstract class Admin_Model_Base_AffiliateProductManufacturer extends Rhema_Model_Abstract
{
    public function setTableDefinition()
    {
        $this->setTableName('affiliate_product_manufacturer');
    ...
    public function setUp()
    {
        ...
        $this->hasOne('Admin_Model_AffiliateProduct as AffiliateProduct', array(
             'local' => 'id',
             'foreign' => 'affiliate_product_manufacturer_id'));
