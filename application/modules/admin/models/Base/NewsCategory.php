...
Doctrine_Manager::getInstance()->bindComponent('Admin_Model_NewsCategory', 'admin');
 ...
 * @property Admin_Model_News $News
 * 
 * @package    ##PACKAGE##
 * @subpackage RhemaSys
 ...
 */
abstract class Admin_Model_Base_NewsCategory extends Rhema_Model_Abstract
{
    ...
    {
        parent::setUp();
        $this->hasOne('Admin_Model_News as News', array(
             'local' => 'id',
