...
Doctrine_Manager::getInstance()->bindComponent('Admin_Model_Salutation', 'admin');

/**
 * Admin_Model_Base_Salutation
 * 
 ...
 */
abstract class Admin_Model_Base_Salutation extends Rhema_Model_Abstract
{
