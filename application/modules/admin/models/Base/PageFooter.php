...
Doctrine_Manager::getInstance()->bindComponent('Admin_Model_PageFooter', 'admin');

/**
 * Admin_Model_Base_PageFooter
 * 
 ...
 */
abstract class Admin_Model_Base_PageFooter extends Rhema_Model_Abstract
{
    public function setTableDefinition()
    {
        $this->setTableName('page_footer');
