 ...
 */
class Help_Model_HelpTemplateLayout extends Help_Model_Base_HelpTemplateLayout
{
		 		...
		 		foreach($res as $sxnSeq => $val){
		 			foreach($val as $type => $itemData){
		 				foreach($itemData as $itemId => $itemSeq){
				 			$obj = new $model();
					 		$obj->help_template_id 	= $template_id;
					 		$obj->help_section_id 	= $aSexn;				 		 			 		
					 		$obj->help_field_id		= $itemId;
