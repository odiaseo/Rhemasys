 ...
 * @version   $Id: JqGrid.php 1561 2011-01-13 00:33:07Z martin.minka $
...
HTML;
    ...
    public function prepareOptions()
    {
        ...
        // prepare navigation
/*        $this->_postCommands[] = sprintf(
            "jqGrid('navGrid', '#%s',{edit:true,add:true,del:true,search:true,view:true})",
            $this->jqgGetIdPager()
        );*/
		$this->_postCommands[] =  $this->getExtendedNavbarConfiguration(); // hack to use bespoke configs
